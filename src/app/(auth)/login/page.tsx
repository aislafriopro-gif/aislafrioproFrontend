    ...
    return (
        ...
        <main className="flex flex-1  items-center  box-sizing: border-box justify-center px-4 py-12">
            <div className="w-200.5 rounded-xl  bg-white p-8 shadow-lg border border-gray-200">
        ...
        <footer className="py-6 text-center text-sm text-gray-500 border-t border-gray-200 bg-white">
            &copy; {new Date().getFullYear()} AislaFrioPro. Todos los derechos reservados.
        </footer>
        </div>
    );
    }